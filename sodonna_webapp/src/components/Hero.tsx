...
export function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-6 overflow-hidden">
      <div className="max-w-[1400px] mx-auto w-full flex flex-col md:flex-row items-center gap-10 relative z-10">
        {/* Image LEFT — large */}
        <motion.div
        ...
        >
          <div className="rounded-[24px] border border-white/10 overflow-hidden shadow-[0_0_80px_rgba(124,58,237,0.12)]">
            <img
